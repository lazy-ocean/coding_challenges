 ...
 */
// prettier-ignore
const getStringFromTemplate = (firstName, secondName) => `Hello, ${firstName} ${secondName}!`;
 ...
 */
const extractNameFromTemplate = (str) => {
  const arr = str.split(', ');
...
const getCardId = (card) => {
  ...
  return ranks.indexOf(rank) + 13 * suits.indexOf(suit) - 1;
};
