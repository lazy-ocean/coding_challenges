...
const tasks = require("../src/02-numbers");

describe("02-numbers-tasks", () => {
  test("getRectangleArea should return a square of rectangle", () => {
    assert.equal(tasks.getRectangleArea(5, 10), 50);
    assert.equal(tasks.getRectangleArea(5, 5), 25);
  });

  test("getCicleCircumference should return a circumference of cicle", () => {
  ...
  test("getAverage should return an average of two numbers", () => {
  ...
  test("getDistanceBetweenPoints should return a distance between points", () => {
  ...
  test("getLinearEquationRoot should return a root of linear equation", () => {
  ...
  test("getAngleBetweenVectors should return a angle (in radians) between two linear vectors", () => {
  ...
  test("getLastDigit should return a last digit of the number", () => {
  ...
  test("parseNumberFromString should return a number from the given string representation", () => {
  ...
  test("getParallelipidedDiagonal should return a diagonal length of the rectagular parallepiped", () => {
  ...
  test("roundToPowerOfTen should return an number rounded to specified power of 10", () => {
  ...
  test("isPrime should return true if specified number is prime", () => {
  ...
  test("toNumber should convert any value to number or return the default", () => {
